...
```
        0           A tree with 5 nodes and 4 edges.
       / \          - Node 0 is the root
      1   2         - Nodes 3, 4 are leaves (degree 1)
     / \            - Node 1 is internal (degree 3: edges to 0, 3, 4)
    3   4           - Exactly one path between any two nodes
```
